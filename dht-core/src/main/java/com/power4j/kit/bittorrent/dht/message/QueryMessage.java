...
public class QueryMessage extends AbstractMessage {
	...
	private final BepDict arguments;

	public QueryMessage(BepStr transaction, @Nullable BepStr version, BepStr method, BepDict arguments) {
	...
	public BepStr getMethod() {
		return method;
	}

	public BepDict getArguments() {
		return arguments;
	}
